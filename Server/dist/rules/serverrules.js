...
exports.ServerRules = void 0;
class ServerRules {
    /**
     * Create initial game state
     */
    static createGameState(ruletype, playerIds) {
        return {
            ruletype: ruletype,
     ...
     */
    static canPlayerShoot(state, playerId) {
        if (state.gameOver)
            return false;
     ...
     */
    static processShot(state, snapshot, outcomes, shooterId) {
     ...
     * Process 8-ball shot
     */
    static processEightBallShot(state, snapshot, outcomes) {
        ...
        const playerBallsPotted = pottedBallNumbers.filter(n => {
            if (playerGroup === "solids")
                return solidNumbers.includes(n);
            if (playerGroup === "stripes")
                return stripeNumbers.includes(n);
            return false;
        });
     ...
     */
    static processSnookerShot(state, snapshot, outcomes) {
        const pottedBalls = outcomes.filter(o => o.type === "pot");
        const pottedBallIds = pottedBalls.map(o => o.ballId);
     ...
     * End the game
     */
    static endGame(state, currentPlayerWins, message) {
        state.gameOver = true;
...
exports.ServerRules = ServerRules;
//# sourceMappingURL=serverrules.js.map